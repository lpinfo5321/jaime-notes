    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="min-w-0 flex-1">
          <input
            ...
            placeholder="Título…"
            className="w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm font-semibold outline-none ring-zinc-300 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:placeholder:text-zinc-400 dark:ring-zinc-600"
          />
          {note.template_snapshot ? null : (
            <textarea
              ...
              className="mt-3 min-h-[220px] w-full resize-y rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm outline-none ring-zinc-300 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:placeholder:text-zinc-400 dark:ring-zinc-600"
            />
          )}
        </div>
        ...
        <div className="flex shrink-0 flex-row gap-2 md:flex-col">
          ...
          <button
            type="button"
            onClick={removeNote}
            className="rounded-xl border border-red-200 bg-white px-3 py-2 text-sm font-medium text-red-700 hover:bg-red-50 dark:border-red-800/50 dark:bg-zinc-800 dark:text-red-400 dark:hover:bg-red-900/20"
          >
            Eliminar
          </button>
      ...
      {note.template_snapshot ? (
        <div className="mt-4 rounded-2xl border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-900">
          <div className="mb-2 text-sm font-semibold dark:text-zinc-100">
            Notas adicionales
          </div>
          <textarea
            value={body}
            ...
            className="min-h-[140px] w-full resize-y rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none ring-zinc-300 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:placeholder:text-zinc-400 dark:ring-zinc-600"
          />
        </div>
      ) : null}
      ...
      <div className="mt-4">
        ...
        <input
          ...
          className="mt-2 w-full rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm outline-none ring-zinc-300 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:placeholder:text-zinc-400 dark:ring-zinc-600"
        />
...
function TemplateForm({
  ...
  const inputBase =
    "w-full rounded-lg border border-transparent bg-white px-3 py-2 text-sm outline-none ring-zinc-300 focus:ring-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 dark:ring-zinc-600";
