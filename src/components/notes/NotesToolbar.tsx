...
export default function NotesToolbar({ initial, topTags }: Props) {
  ...
  return (
    <div className="md:sticky md:top-[60px] md:z-10 -mx-4 border-b border-zinc-200 bg-white/80 px-4 py-3 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/70">
