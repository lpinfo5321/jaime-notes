    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <div className="mb-5 flex gap-2 rounded-xl bg-zinc-100 p-1 text-sm dark:bg-zinc-800">
        <button
          ...
          className={[
            ...
            mode === "login"
              ? "bg-white shadow-sm dark:bg-zinc-700 dark:text-zinc-100"
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        <label className="block text-sm">
          <span className="mb-1 block font-medium dark:text-zinc-200">
            Email
          </span>
          <input
            value={email}
        ...
        {info ? (
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-800 dark:border-emerald-900 dark:bg-emerald-950 dark:text-emerald-300">
            {info}
          </div>
        ) : null}
