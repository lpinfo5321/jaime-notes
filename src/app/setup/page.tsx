        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <div className="mt-5 space-y-3 text-sm">
            ...
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <pre className="mt-2 overflow-auto rounded-xl border border-zinc-200 bg-white p-3 text-xs dark:border-zinc-800 dark:bg-zinc-900">
{`NEXT_PUBLIC_SUPABASE_URL=...
NEXT_PUBLIC_SUPABASE_ANON_KEY=...`}
              </pre>
              <div className="mt-2 text-xs text-zinc-600 dark:text-zinc-300">
                En Windows (PowerShell) dentro de{" "}
                <code className="rounded bg-white px-1 dark:bg-zinc-900">
                  app-jaime
                </code>
                :
...
notepad .env.local`}
            ...
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <div className="mt-1 text-zinc-700 dark:text-zinc-200">
                ...
                . Si algo falla, revisa el mensaje exacto y me lo pegas aquí.
              </div>
            </div>
          </div>
